...
static const char qt_meta_stringdata_Label[] = {
    "Label\0filenamesDropped(QStringList)\0"
    "filenames\0\0clicked(QPoint)\0pos\0"
};
...
void Label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->filenamesDropped((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
...
// SIGNAL 0
void Label::filenamesDropped(const QStringList & _t1)
{
...
// SIGNAL 1
void Label::clicked(const QPoint & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
